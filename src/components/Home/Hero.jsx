...
const Hero = () => {
  return (
    <div style={{ width: '100%', height: '700px', position: 'relative' }} className='2xl:h-[800px], xl:h-[600px] lg:h-[600px]'>
        <Particles
      ...
      <div className='absolute 2xl:top-[23%] xl:top-[20%] md:top-[25%] sm:top-[20%] top-[20%] 2xl:left-[18%] xl:left-[23%] lg:left-[20%] md:left-[15%] sm:left-[5%] left-[5%]'>
          <div className='2xl:w-fit xl:w-full md:w-full sm:w-full w-full'>
          ...
          <div className='my-10'>
            <h4 className='2xl:text-2xl xl:text-xl lg:text-xl md:text-lg sm:text-base text-base text-center tracking-widest font-light text-gray-600 font-Inter'>Stand up-to-date with the latest cryptocurrencies
            and trends </h4>
          </div>
      ...
      <div>
        <img src={img_1} alt="" className='absolute top-[50%] left-[8%] 2xl:block xl:block md:block sm:hidden hidden '/>
        <img src={img_2} alt="" className='absolute top-[5%] left-[60%] 2xl:block xl:block md:block sm:hidden hidden '/>
        <img src={img_3} alt="" className='absolute top-[60%] left-[90%] 2xl:block xl:block md:block sm:hidden hidden '/>
      </div>
      </div>
  )
}
